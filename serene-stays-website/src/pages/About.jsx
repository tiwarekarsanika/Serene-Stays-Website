...
const About = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full">
      ...
      {/* Content Section */}
      {/* <div className="font-body text-lg text-left px-20 flex flex-col gap-10 py-10">
        <p>
          At Serene Stays by Prasad Hospitality, we redefine luxury and comfort with our exclusive collection of villas and resort rooms across Virar, Goa, Mahabaleshwar, and Thailand. With over 20 years of experience in the hospitality industry, we have mastered the art of creating unforgettable stays tailored to your needs. Whether you are looking for a peaceful retreat, a family vacation, or a grand celebration, our properties offer the perfect setting. Each villa is thoughtfully designed with private pools, lush green lawns, and spacious interiors, ensuring a blend of opulence and relaxation. Our resort rooms provide a cozy yet elegant ambiance, catering to travelers who seek comfort with a touch of sophistication.
        </p>

        <p>
          Strategically located in some of the most sought-after destinations, our properties offer a unique blend of natural beauty and modern luxury. Imagine waking up to the serene beaches of Goa, enjoying the scenic hill views of Mahabaleshwar, or unwinding amidst the tropical charm of Thailand. Whether you prefer a secluded escape or an adventurous getaway, our locations promise an experience that is both stunning and memorable. We take pride in offering personalized hospitality, ensuring that your stay is seamless and filled with delightful moments. From intimate gatherings to grand events, our villas and resorts are designed to accommodate every occasion with elegance and ease.
        </p>

        <p>
          At Serene Stays, we understand the importance of flexibility and convenience. Our hassle-free booking process and flexible cancellation policies allow you to plan your vacation with confidence. With our dedicated team handling every detail of your stay, you can focus on making memories with your loved ones. Whether it’s a weekend escape or a long vacation, we invite you to experience luxury, comfort, and exceptional service like never before.
        </p>
      </div> */}
      <div className="font-body text-lg text-left px-20 py-10">
        <div className="grid md:grid-cols-2 gap-10 text-justify">
          ...
          <p> 
            ...
            At Serene Stays, we understand the importance of flexibility and convenience. 
